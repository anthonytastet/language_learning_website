    ...
    <div class='content__categories'>
        <?php
            foreach($postsAndCategories as $postAndCategories){
                if($post[0]["name"] == $postAndCategories["name"]){
                    echo "<a class='btn btn--secondary' href='index.php?category_name=".$postAndCategories["categories"]."'>".$postAndCategories["categories"]."</a>";
                }
            }
        ?>
    </div>
